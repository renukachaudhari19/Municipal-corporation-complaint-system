...
if(isset($_POST['username']) && isset($_POST['password']))
        ...
        {
            $_SESSION['name']=$name;
            echo "<script>window.location='users/dashboard.php';</script>";
		...
		<div class="container py-xl-5 py-lg-3">
			...
			<div class="row contact-form py-3">
				...
				<div class="col-lg-6 map text-center">
					...
					<img src="1/images/login.jpg" alt="" class="img-fluid" />
				</div>
				<!-- //contact map -->
				<!-- contact form -->
                ...
                <form name="loginform" id="loginform" action="" method="post">
                    <p>
                        <label for="user_login" style="width:100%;">Email<br />
                            <input type="email" name="username" id="user_login" class="form-control"   size="20" required /></label>
                    </p>
                    <p>
