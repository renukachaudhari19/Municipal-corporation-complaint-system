...
<body>
	...
	<!-- register -->
	<?php
include 'users/Application/DB_Functions.php';
...
$Address=($_POST['Address']);
        ...
        if ($obj->StoreCategory($name,$Email,$password,$Income,$dob,$gender,$Mobile,$Address)==TRUE) // Here we call the CheckLogin function for admin login through the object        
        {
           
            echo "<script>alert('Register Succesfull!');window.location='index.php';</script>";
		...
		<div class="container py-xl-5 py-lg-3">
			...
			<div class="row contact-form py-3">
				...
				<div class="col-lg-6 map text-center">
					...
					<img src="1/images/register.jpg" alt="" class="img-fluid" />
				</div>
				<!-- //contact map -->
				<!-- contact form -->
                ...
                <form name="loginform" id="loginform" action="" method="post">
                    <p>
                        <label for="user_login">Full Name<br />
                            <input type="text" name="name" style="height: 29px;" id="user_login" class="form-control"   size="20" required /></label>
                    </p>
                     <p>
                        <label for="user_login">Email<br />
                            <input type="email" name="Email" style="height: 29px;" id="user_login" class="form-control"   size="20" required /></label>
                    </p>
                     <p>
                        <label for="user_pass">Password<br />
                            <input type="password"  title="PLease Enter Password of 5 character" name="password" style="height: 29px;" id="user_pass" class="form-control"   size="20" required /></label>
                    </p>
                   
                            
                     <p>
                        <label for="user_login">Village<br />
                            <input type="text" name="dob"  pattern="[A-Za-z].{3,}" title="PLease Enter Valid Village Name" style="height: 29px;" id="user_login" class="form-control"   size="20" required /></label>
                    </p>
                     <p>
                    ...
                    <p>
                        <label for="user_login">Mobile <br />
                            <input type="text" name="Mobile" pattern="[789][0-9]{9}" title="PLease Enter Valid Mobile Number" style="height:29px;" id="user_login" class="form-control"   size="20" required /></label>
                    </p>
                     <p>
                        <label for="user_login">Address<br />
                            <input type="text" name="Address" style="height:29px;" id="user_login" class="form-control"   size="20" required /></label>
                    </p>
